    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
        ...
        <div className="mt-2 flex items-center gap-2">
          ...
          <span className="text-gray-600 text-sm">120 minutes</span>
        </div>
        <button 
          type="button"
      ...
      {/* Overall Grades Section - Replacing Next Class */}
      <div className="bg-green-50 p-4 rounded-lg border border-green-200">
        <div className="flex items-center gap-3 mb-2">
          <Award className="text-green-600" size={24} />
          <h3 className="font-semibold text-gray-800">Overall Grades</h3>
        </div>
        <p className="text-3xl font-bold text-gray-800 mb-1">88.5%</p>
