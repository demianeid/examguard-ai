  ...
  return (
    <div className="min-h-screen p-10 pb-0  bg-background">
      ...
      <section className="container min-h-600 pt-20 pb-10 mx-auto px-6 py-16">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-blue-600 mb-6">AI Detection Capabilities</h2>
          <div className="grid md:grid-cols-2 gap-4">
            {[
              'Face matching for identity verification.',
              'Gaze tracking for suspicious movement detection.',
              'Audio anomaly detection for conversation attempts.',
              'Object detection to identify phones or papers.',
